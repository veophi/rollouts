...
func (c *StatefulSetLikeController) UpgradeBatch(canaryReplicasGoal, stableReplicasGoal int32) (bool, error) {
	...
	if isUpgradedDone(set, canaryReplicasGoal, stableReplicasGoal) {
		return true, nil
	}
...
func isUpgradedDone(set *unstructured.Unstructured, canaryReplicasGoal, stableReplicasGoal int32) bool {
